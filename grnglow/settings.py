...
qiniu.conf.ACCESS_KEY = "j3fPccFI3N-QyDszgz1th3UOlFfLp5X5dipeFpxA"
qiniu.conf.SECRET_KEY = "KdhMLLHYSKhazH2qz6caCLlUFIUq6mmxojCYY-yZ"
# 存在七牛上的图片的文件名前缀
QINIU_FILE_PREFIX = 'dandantuan'
# 七牛图片存储的 URL
QINIU_IMG_URL = 'http://stan.bestyiwan.com/'
